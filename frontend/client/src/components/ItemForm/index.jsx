...
const ItemForm = ({ data, setData, setSelectedFile, submitForm, currentLanguage, categories, setCategories, location, setLocation, isEdit}) => {
	...
	return (
        <div dir={currentLanguage === "ar" ? "rtl" : "ltr"} className="col-12 d-flex justify-content-center align-items-center">
            <div className="container d-flex flex-column col-xl-8 col-10  mt-5 mb-3 form-main-container">
                <p className="d-flex col-12 justify-content-center mt-2 p-font">{isEdit ? t("EDITITEM") : t("ADDITEM")}</p>
                <form className="d-flex col-12 flex-column" encType="multipart/form-data" onSubmit={(submitForm)}>
                    <div className="d-flex col-12 flex-lg-row flex-column">
                        <div className="col-lg-6 me-3 ms-3 col-12">
                            <div className="d-flex mt-md-5 mt-1 col-12 flex-md-row flex-column justify-content-around group input-container">
                                ...
                                <div className="col-md-7 col-11">
                                    <input className="col-12 form-control-sm font-large" type="text" placeholder="" name="name" value={data.name} onChange={handleChange}/>
                                </div>
                            </div>
                            <div className="d-flex mt-md-5 mt-1 col-12 flex-md-row flex-column justify-content-around group input-container">
                                            ...
                                            } />
                                    {
                                        ...
                                        {(() => {
                                            let container = [];
                                                ...
                                                container.push(
                                                    <img src={data} className="col-6" key={index} alt=""/>
                                                )
                                                })
                        ...
                        <div className="col-lg-6 me-3 ms-3 col-12 ">
                            ...
                            <div className="d-flex mt-md-5 mt-1 flex-md-row flex-column col-12 justify-content-around group input-container">
                                ...
                                <div className="col-md-7 col-11">
                                    <ExpandableTextArea
                                        name={"description"}
                                        className={"col-12 form-control-sm text-area-description font-medium"}
                    ...
                    <div className="col-12 d-flex justify-content-center mb-lg-3">
                        <input className="col-lg-4 col-10 btn mt-5 mb-2 submit-btn" type="submit" value={isEdit ? t("EditItemLink") : t("AddItemLink")}/>
                    </div>
                </form>
            </div>
        </div>
